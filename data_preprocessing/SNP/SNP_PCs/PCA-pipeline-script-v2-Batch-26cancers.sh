...
JOB=PCA-pipeline-script-v2-batch-in
SH_SCRIPT=$JOB.sh
...
## no COAD or LIHC
CANCERS=(BLCA CESC ESCA KIRC LUSC PAAD PRAD SARC STAD THCA UCEC BRCA GBM HNSC KIRP LGG LUAD OV PCPG READ SKCM TGCT THYM)
#CANCERS=BRCA
