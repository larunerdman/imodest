...
for i in {0..0}; do
	...
	qsub -v WORKING_DIR=$WORKING_DIR,DATA_DIR=$DATA_DIR,INPUT=$CANCER-postqc,OE=$OE,HAPMAP_KEEP=$DATA_DIR/$CANCER-inds-cluster-with-ceu-tsi.txt \
