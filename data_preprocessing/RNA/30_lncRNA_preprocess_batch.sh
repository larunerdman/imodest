...
for i in {0..25}; do
	...
	LNCRNA_EXPRESSION_PROFILE=$HOME_DIR/lncRNA_preprocess_input/TCGA-${CANCERS[i]}-rnaexpr.tsv
	...
	R_JOB="module load R/3.3.2; \
		   ...
		   --LNCRNA_EXPRESSION_PROFILE $LNCRNA_EXPRESSION_PROFILE \
