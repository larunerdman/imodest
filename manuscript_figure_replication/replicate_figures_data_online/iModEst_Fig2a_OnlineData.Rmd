---
title: "iModEst_Fig2a_OnlineData"
...
# r2_data_path = 'C:/Users/larun/Desktop/Modes/Data//tumour pred model performance/r2/r2_data/'
...
# tumour.file.list <- list.files(path = r2_data_path)
...
# tum.vec <- tums
for(cancer in cancers.of.int){
  r2.added.list[[cancer]] <- read_remote_rds(paste0("https://imodesttool.com/api/data/download/full/performance_files/tumour_var_added_files/",cancer,"-var-added-list-allgenes.rds"))
...
ggplot(graph_df,aes(x = variable, y = value,fill = cancer)) + 
