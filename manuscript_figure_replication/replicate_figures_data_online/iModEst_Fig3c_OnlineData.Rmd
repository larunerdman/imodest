...
##BCL2 Fig 3c all miRNA models
```{r}

full.gene.df.sub = full.gene.df[full.gene.df$var.added.f == "miRNA",]

ggplot(full.gene.df.sub,aes(x = var.added.f, y = r2.growth,fill = cancer)) + 
...
##BCL2 Fig 3c all miRNA models with TF
```{r}
...
cond.gene.df.mlt.sub = cond.gene.df.mlt[cond.gene.df.mlt$var.added.f == "miRNA",]
...
##BCL2 Fig 3c all miRNA models with TF + methyl
```{r}
...
##BCL2 Fig 3c all miRNA models with TF + methyl + SNP
```{r}
